// ARCHIVED / DEAD DEMO — moved out of ioBroker.modbus.
//
// This is not a unit test but a manual demo script: it opens a live TCP connection
// to a Modbus slave on localhost:502 and reads 50 input registers. It depends on the
// external `modbus-stack` package and a running slave, so it is not part of any test
// run. Kept here for reference only.
